...
$to = "alexwebcourses@gmail.com"; // Тут пишем почту на которую будут приходить письма
...
echo '<p>Сообщение успешно отправлено</p><br><a href="alexodesign.404.dp.ua">Вернуться на главную</a> '; // Отправка успешна
}
ELSE {
